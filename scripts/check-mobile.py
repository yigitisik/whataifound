...
def check_tap_targets(css, problems):
    ...
    CONTRACT = [
        ...
        (".qv-seg button", "grow", "height",
         "chart view switch: a segmented control, so adjacent cells cannot overlap"),
        (".qv-key", "expand", None,
         "chart legend key, wrapping in a row beside its neighbours"),
